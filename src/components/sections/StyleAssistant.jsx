...
export default function StyleAssistant() {
    ...
    return (
        <section className="bg-white px-6 py-24">
            <div className="mx-auto max-w-6xl overflow-hidden rounded-[2rem] border border-pink-100 bg-gradient-to-br from-pink-50 via-white to-pink-100 shadow-xl">
                {!iniciado && (
                    <div className="px-8 py-16 text-center md:px-16">
                        ...
                        <h2 className="mx-auto mt-6 max-w-3xl text-4xl font-bold leading-tight text-gray-900 md:text-5xl">
                        ...
                        <button
                            ...
                            className="glow-touch mt-8 rounded-full bg-pink-600 px-8 py-4 font-semibold text-white shadow-lg transition duration-300 hover:-translate-y-1 hover:bg-pink-700 hover:shadow-xl"
                        >
                        ...
                        <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                            {preguntaActual.opciones.map((opcion) => (
                                <button
                                    ...
                                    className="glow-touch group rounded-3xl border-2 border-pink-100 bg-white p-7 text-left shadow-sm transition duration-300 hover:-translate-y-2 hover:border-pink-400 hover:shadow-xl"
                                >
                        ...
                        <div>
                            ...
                            <div className="mt-9 flex flex-wrap gap-4">
                                <button
                                    ...
                                    className="glow-touch rounded-full bg-pink-600 px-7 py-3 font-semibold text-white transition hover:bg-pink-700"
                                >
                                    ✨ Quiero este diseño
                                </button>
                                ...
                                <button
                                    type="button"
                                    onClick={reiniciar}
                                    className="rounded-full border-2 border-pink-200 px-7 py-3 font-semibold text-pink-600 transition hover:border-pink-500 hover:bg-pink-50"
                                >
                                    Intentar de nuevo
                                </button>
                            </div>
